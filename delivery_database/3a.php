  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  			...
  			<article><b>
		<p style="color: solid gray ;text-align:center; font-size:120%;"> 3.a) Detalii despre livrari, ordonate crescator dupa cantitate si descrescator dupa id-ul furnizorului pentru aceeasi cantitate. </p>
		...
		<tr>
			...
			<?php
				$con="SELECT *
				FROM Livrari
				ORDER BY cantitate DESC, idf";
				$result=mysqli_query($conectare, $con);
