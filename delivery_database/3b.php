  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  		...
  		<article>
		<p style="color: solid gray; font-size:80%;text-align:center"><b> 3.b) Numele proiectelor care incep cu 'A' din orasul Satu-Mare</p>
		<form action="rezultate3b.php" method=post>
<table border=1>
<tr>
