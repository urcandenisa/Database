  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  		...
  		<article> 
		<p style="color: solid gray; font-size: 80%;text-align:center"><b> 4.a) Numele proiectelor, componentelor si oraselor astfel incat toate se afla in acelasi oras</p>
		<form action="rezultate4a.php" method=post>
<table border=1>
<tr>
<td>Introduceti orasul:</td>
<td align="center"><input type=text name="oras" size="10" maxlength="20"></td>
</tr>
<tr>
