  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  		...
  		<article>
		<p style="color: solid gray; font-size: 80%;text-align:center"><b> 4.b) Perechile de componente (idc1, idc2) asttfel incat ambele sa fie livrate de acelasi furnizor pentru acelasi proiect. </p>
		<?php
include "4bproc.php";
