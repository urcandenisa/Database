  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  		...
  		<article>
		<p style="color: solid gray; font-size: 80%;text-align:center"><b> 5.b) Codurile proiectelor din orasul proiectului ce are codul: </p>
		<form action="rezultate5b.php" method=post>
<table border=1>
<tr>
<td>Introduceti codul proiectului:</td>
<td align="center"><input type=text name="idp" size="10" maxlength="20"></td>
</tr>
<tr>
