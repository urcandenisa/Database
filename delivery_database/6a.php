  ...
  <script>
    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
  		...
  		<article>
		<p style="color: solid gray; font-size: 80%;text-align:center"><b> 6.a) Numarul proiectelor din fiecare oras. </p>
		...
		<th>Numar Proiecte</th>
			...
			<?php
				$con="SELECT oras AS 'Oras', COUNT(oras) AS 'Numar Proiecte' FROM Proiecte GROUP BY oras";
