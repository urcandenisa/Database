    ...
    function closeSlideMenu(){
      ...
      document.getElementById('main').style.marginLeft = '0';
		...
		<article>
			...
			<p style="font-size:190%; text-align:left;"><b>Proiect final Baze de Date</b></p>
			<p style="font-size:150%; text-align:left"> <b>Urcan Denisa-Teodora </b></p>
			<p style="font-size:150%; text-align:left"> <b>Grupa 30226, Seria B</b></p>
			<p style="font-size:150%; text-align:left"> <b>CTI Romana</b></p>
			<p style="font-size:150%; text-align:left"> <b>Prof. Gabriel Dragomir</b></p>
